...
import { fetchAllCamerasWithInstances } from '../lib/api'
import yaps from '../lib/yaps'
import snackbar, { snack } from '../utils/snackbar'
import { debug, success } from '../utils/colorLog'
    ...
    try {
      return new Promise((resolve) => {
        ...
        this.ws.onopen = async () => {
          ...
          snack.success('Connected to :: ' + this.host)
          resolve(camList)
        }
