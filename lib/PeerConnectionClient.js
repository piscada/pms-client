// ES5 rewrite of :: https://github.com/medooze/media-server-client-js

import { SDPInfo, StreamInfo, TrackInfo, Direction } from "semantic-sdp";
...
function fixLocalSDP(sdp, transceivers) {
	...
	for (const transceiver of transceivers) {
		...
		const fixSimulcastEncodings = transceiver.fixSimulcastEncodings ? transceiver.fixSimulcastEncodings.sort((a, b)=>{
